...
export default function Header1({ onOpenSearch, onToggleSidebar, onOpenHamburgerMenu }: Header1Props) {
          ...
          <div className="row align-items-center">
            <div className="col-xl-3 col-6">
              <div className="at-header-logo">
                <Link href="/" className="d-inline-flex align-items-center gap-2 text-decoration-none">
                  <img className="invert-0" height={44} style={{ width: "auto", maxHeight: "44px", filter: "none !important" }} src={logoUrl} alt={companyName} />
                  <h6 className="fw-700 fz-20 text-white mb-0 text-nowrap">{companyName}</h6>
                </Link>
              </div>
            </div>
            ...
            <div className="col-xl-2 col-6">
              <div className="at-header-right gap-3 d-flex justify-content-end align-items-center">
                <button type="button" className="at-header-search-btn at-search-click" onClick={onOpenSearch}>
                ...
                <button type="button" className="at-menu-bar at-header-sidebar-btn text-white" onClick={onToggleSidebar}>
