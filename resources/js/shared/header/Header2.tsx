...
export default function Header2({ onOpenSearch, onToggleSidebar, onOpenHamburgerMenu }: Header2Props) {
          ...
          <div className="row align-items-center">
            ...
            <div className="col-xl-3 col-6">
              <div className="at-header-logo">
                <div className="text-decoration-none d-inline-flex align-items-center gap-2" style={{ cursor: "default" }}>
                  ...
                  />
                  <h6 className="fw-700 fz-20 mb-0 text-white text-nowrap" style={{ letterSpacing: "-0.02em" }}>
                    {companyName}
                  </h6>
                </div>
              </div>
            ...
            <div className="col-xl-2 col-6">
              <div className="at-header-right gap-3 d-flex justify-content-end align-items-center">
                <button type="button" className="at-header-search-btn at-search-click" aria-label="Search" onClick={onOpenSearch}>
