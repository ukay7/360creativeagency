...
export default function Header3({ onOpenSearch, onToggleSidebar, onOpenHamburgerMenu }: Header3Props) {
          ...
          <div className="row align-items-center">
            <div className="col-xl-1 col-6">
              <div className="at-header-logo">
                <Link to="/" className="text-decoration-none d-inline-flex align-items-center gap-2">
                  <img width={30} height={30} src="/assets/imgs/template/logo/favicon.svg" alt="Orisa" />
            ...
            <div className="col-xl-4 col-6">
              <div className="at-header-right gap-3 d-flex justify-content-end align-items-center">
                ...
                <Link className="at-btn d-none d-md-block" to="/pricing">
                  <span>
