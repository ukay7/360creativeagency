...
const TESTIMONIALS = [
    {
        quote:
            '"360 Creative Agency built our entire e-commerce platform from scratch. The app is fast, beautiful, and our sales doubled in 3 months."',
        img: "/assets/imgs/template/avatar/avatar-6.webp",
        name: "Sarah Mitchell",
        position: "Founder",
        company: "FreshCart, Toronto",
    },
    {
        quote:
            '"Their video editing team turned our raw footage into cinematic content that went viral. Over 2M views on our brand launch reel!"',
        img: "/assets/imgs/template/avatar/avatar-7.webp",
        name: "James Rodriguez",
        position: "Marketing Director",
        company: "Aura Luxe, Vancouver",
    },
    {
        quote:
            '"From logo design to social media templates — they gave our brand a complete makeover. Our Instagram engagement tripled in weeks."',
        img: "/assets/imgs/template/avatar/avatar-8.webp",
        name: "Priya Sharma",
        position: "CEO",
        company: "GlowUp Beauty, Calgary",
    },
];
