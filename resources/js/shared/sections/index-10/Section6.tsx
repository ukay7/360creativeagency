            ...
            <div className="sec-6-home-10__container">
                <div className="sec-6-home-10__layout">
                    ...
                    {MEMBERS.map((member) => (
                        ...
                        >
                            <Link className="sec-6-home-10__member-link" to={member.href}>
                    ...
                    <div className="sec-6-home-10__foot at_fade_anim" data-delay="0.18">
                        ...
                        <Link className="sec-6-home-10__cta d-inline-flex align-items-center gap-3 mt-4 at_fade_anim" to="/contact-1">
