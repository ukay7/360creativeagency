...
const SOCIAL_ITEMS = [
    {
        label: "LinkedIn",
        href: "https://www.linkedin.com/company/360creativeagency",
        icon: (
    ...
    {
        label: "Instagram",
        href: "https://www.instagram.com/360creativeagency",
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                <path
    ...
    {
        label: "Facebook",
        href: "https://www.facebook.com/360creativeagency",
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                <path
                        ...
                        <div className="at-about-title-wrap mb-30">
                            ...
                            <div className="at-about-content d-flex flex-md-row flex-column justify-content-between gap-4 pt-40">
                                <div className="d-flex gap-4 w-lg-50">
                                    ...
                                    <div>
                                        <h6 className="fw-600">Headquarters</h6>
                                        <span className="fz-font-md neutral-500">
                                            85 Dickson Hill Rd
                                            <br className="d-block" />
                                            Markham, ON L3P 3J3, Canada
                                            <br className="d-block" />
                                            Phone:{" "}
                                ...
                                <div className="d-flex gap-4 w-lg-50">
                                    ...
                                    <div>
                                        <h6 className="fw-600">Business Hours</h6>
                                        <span className="fz-font-md neutral-500">
                                            Monday – Friday
                                            <br className="d-block" />
                                            9:00 AM – 6:00 PM EST
                                            <br className="d-block" />
                                            Weekend:{" "}
                                            <span className="neutral-900">By Appointment</span>
                                            <br className="d-block" />
                                            Response:{" "}
                                            <span className="neutral-900">Within 1–2 Business Days</span>
                                        </span>
                                    </div>
                                </div>
                            </div>
