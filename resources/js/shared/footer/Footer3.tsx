          ...
          <div className="row g-5 pb-45">
            ...
            <div className="col-lg-3 col-md-6 d-flex flex-column justify-content-between">
              <div className="at-footer-widget alt-footer-link-item-wrap row">
                ...
                <div className="alt-footer-link-item col-6">
                  <ul>
                    <li className="mb-15"><Link to="/product-archive">Shop</Link></li>
                    <li className="mb-15"><Link to="/pricing">Pricing</Link></li>
                    <li className="mb-15"><Link to="/product-cart">Cart</Link></li>
                    <li className="mb-15"><Link to="/product-checkout">Checkout</Link></li>
                  </ul>
                </div>
              </div>
